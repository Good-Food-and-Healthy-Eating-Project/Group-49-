...
class RecipeIngredientsTableTest{
    ...
    fun should_insert_recipe_ingredient_success(){
        transaction{
            ...
            val result = RecipeIngredients
                .selectAll()
                .where{(RecipeIngredients.recipe_id eq recipeId) and (RecipeIngredients.food_id eq foodId)}
                .singleOrNull()
    ...
    fun should_delet_recipe_ingredient_success(){
        transaction{
            ...
            val foodId = Foods.insert{
                ...
                RecipeIngredients.deleteWhere{(RecipeIngredients.recipe_id eq recipeId) and (RecipeIngredients.food_id eq foodId)}
                val result = RecipeIngredients
                .selectAll()
                .where{(RecipeIngredients.recipe_id eq recipeId) and (RecipeIngredients.food_id eq foodId)}
                .singleOrNull()
    ...
    fun should_update_recipe_ingredient_success(){
        transaction{
            ...
            val foodId = Foods.insert{
                ...
                RecipeIngredients.update({(RecipeIngredients.recipe_id eq recipeId) and (RecipeIngredients.food_id eq foodId)}){
