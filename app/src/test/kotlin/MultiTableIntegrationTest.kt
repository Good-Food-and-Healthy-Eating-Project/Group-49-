...
class MultiTableIntegrationTest{
    ...
    private fun CrateFoodLogItem(foodLogId:Int,foodId:Int){
        FoodLogItems.insert{
    ...
    private fun CrateRole(roleName:String):Int{
        val RoleId = Roles.insert{
            it[Roles.role_name] = roleName
        }get Roles.role_id
        return RoleId
    }
    ...
    private fun createRecipeIngredient(recipeId:Int,foodId:Int){
    ...
    fun should_assign_role_to_user_success(){
        transaction{
            ...
            .selectAll()
            .where{(UserRoles.user_id eq userId) and (UserRoles.role_id eq roleId)}
            .singleOrNull()
    ...
    fun should_create_food_log_with_item(){
        transaction{
            ...
            val foodLog = FoodLogs
            .selectAll()
            .where{FoodLogs.food_log_id eq foodLogId}
            .singleOrNull()
            val item = FoodLogItems
            .selectAll()
    ...
    fun should_crate_recipe_with_ingredients(){
        transaction{
            ...
            .selectAll()
            .where{(RecipeIngredients.food_id eq foodId) and(RecipeIngredients.recipe_id eq recipeId)}
            .singleOrNull()
    ...
    fun should_link_client_with_profesional(){
        transaction{
            ...
            .selectAll()
            .where{(ClientProfessionalLink.client_id eq clientId) and (ClientProfessionalLink.professional_id eq professionalId)}
            .singleOrNull()
            assertNotNull(link)
